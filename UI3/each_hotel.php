...
$feedback = "SELECT * from comments join hotel using(hotel_id) join customer using(customer_id) where hotel_id = '$hotelid'";
...
$each_room = "SELECT roomtype.roomtype_id, roomtype.room_details, roomtype.room_type, roomtype.room_price, photo.photo_url 
                    ...
                    WHERE roomtype.hotel_id = '$hotelid'";
$roomPhotosResult = $conn->query($each_room);

$minRoomPriceQuery = "SELECT MIN(roomtype.room_price) AS min_price FROM roomtype WHERE roomtype.hotel_id = '$hotelid'";
    ...
    <div class="cover">
                ...
                <section class="center">
                    <div class="box2">
                        <div class="room-info">
                            ...
                            <a href="reserve.php?hotel_id=<?php echo $hotelid; ?>&roomtype_id=<?php echo $typeInfo["roomtype_id"]; ?>">
                                ...
                                <input type="button" value="จองเลย" class="book" onclick="checkAndReserve()">
                            </a>
        ...
        <div>
            ...
            <form action="process_comment.php" method="post">
                ...
                <p><input type="text" name="name_cutomer" placeholder="ชื่อ" style="width:17%; font-size:20px; font-family:'Athiti', sans-serif; margin-left:35px;">
                ...
                <button type="submit" class="btn btn-info" style="width:10%; font-size:20px; font-family:'Athiti', sans-serif; margin-left:35px; border-radius: 5px; background-color: #59A3B4;">ส่งความคิดเห็น</button>
                <p><br></p>
            </form>
